...
namespace ysl
{
	...
	template <class T>
	struct nocheck_offset { constexpr static int value = 0; };
	template <typename... Args>
	struct nocheck_offset<tuple<Args...>> { constexpr static int value = 1 + size_encoding_size(sizeof...(Args)); };
